...
bool Map1Page3Scene::init()
{
	...
	this->createMap(Point(152.5, 180), 16, 1, "stone.png");
	...
	this->createMap(Point(450, 385), 5, 6, "stone.png");
	this->createMap(Point(502.5, 402.5), 7, 1, "stone.png");

	//Set the boundary

	//this->createMap(Point(-12.5, 127.5), 15, 4);
	this->createMap(Point(-12.5, -12.5), 20, 4);
	this->createMap(Point(12.5, 492.5), 26, 1);
	this->createMap(Point(652.5, 402.5), 20, 5);
...
cocos2d::Point & Map1Page3Scene::newPostion()
{
	return this->postion;
}
...
bool Map1Page7Scene::init()
{
	...
	this->createMap(Point(25, 90), 3, 1, "brick_1.png");
	...
	this->createMap(Point(100, 155), 3, 1, "brick_1.png");
	...
	this->createMap(Point(-12.5,-12.5),17,4);
	this->createMap(Point(12.5,492.5),26,1);
	this->createMap(Point(652.5,0),20,4);
...
cocos2d::Point & Map1Page7Scene::newPostion()
{
	return this->postion;
}